...
<p>
This is archive of files which are partially covered in Federal Removal Package, are not frequently referenced, but could carry practical value for additional motions and historical record.
</p>
</div>
...
<div class="evidence-binder-section toc-section">
  ...
  <nav class="toc-nav">
    <div class="toc-grid">
      <!-- Evidence Sets -->
      <div class="toc-group">
        <a href="#video-evidence-archive" class="toc-link">Video Evidence Archive</a>
        <a href="#orders-post-dq" class="toc-link">Orders Post-Disqualification</a>
        <a href="#denial-orders" class="toc-link">Denial Orders</a>
      </div>
